...
export default function WidgetDemoPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      />
      <Card className="mb-6">
        <p className="mb-2 text-sm font-medium text-[#3f3f46]">설치 스니펫</p>
        <pre className="overflow-x-auto rounded-xl border border-black/10 bg-[#f1f1f3] px-4 py-3 text-sm text-[#27272a]">
      ...
      <Card>
        <p className="mb-3 text-sm font-medium text-[#3f3f46]">미리보기 (실제 위젯)</p>
